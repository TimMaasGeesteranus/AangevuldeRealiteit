...
Dit is de planning zoals beschreven in het plan van aanpak. Per onderdeel zal teruggeken worden op de planning. 
...
Het inlevermoment van het plan van aanpak en storyboard is gehaald. 
Omdat we niet te lang wilden blijven hangen bij eventuele opdrachtgevers hebben we een deadline opgesteld voor het vaststellen van de usecase. Op deze datum hebben we besloten het contact met alle bedrijven stop te zetten en onze eigen opdracht te realiseren.
Deelvraag 1,3 en 4 zijn op tijd afgerond. Bij deelvraag 2 is dit niet gelukt, deze is 15-11-19 pas afgerond. 
De inlevermomenten van het onderzoeksverslag en het tussentijds product zijn uitgesteld. Dit was de keuze van onze docenten, wij hebben hier geen invloed op gehad. 
...
We hebben ons tot nu toe aan de sprints gehouden. We zitten nu in sprint twee. 
...
Deze afspraken hebben op een enkeling na allemaal plaatsgevonden. Sommigen zijn verplaatst maar dat had verder geen invloed op onze planning. 
...
Hier hebben we ons de eerste paar weken niet aan gehouden. De laatste paar weken gaat dit al beter. We streven ernaar dit de komende tijd vol te houden. 
## Gantt chart
...
Volgens onze Gantt chart lopen we op schema. We zitten nu in sprint twee en dat is volgens de planning. 
