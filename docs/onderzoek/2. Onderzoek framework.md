...
### **Implementatiegemak**
Om te beginnen met Mapbox en React Native heeft Mapbox een [Github-repository](https://github.com/mapbox/react-native-mapbox-ar) aangemaakt. Hier is een Demo te vinden om je op gang te helpen. Om deze demo te laten werken moet er gewerkt worden met react-viro. Zoals te lezen bij het onderzoek over ViroReact maken wij hier geen gebruik van. Daardoor lukt het niet om de demo van Mapbox aan de praat te krijgen. 
...
### **Support & community**
Op [Mapbox Docs](https://docs.mapbox.com/) is een hele hoop te vinden over het gebruik van Mapbox. Alleen voor het onderdeel mapbox-AR is zo goed als niks te vinden. 
