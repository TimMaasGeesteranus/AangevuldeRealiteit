...
Zoals te zien is op [Stack overflow](https://stackoverflow.com/questions/tagged/vuforia) bestaan er 1302 vragen met de tag *Vuforia*. Er is dus genoeg support beschikbaar van andere developers.
