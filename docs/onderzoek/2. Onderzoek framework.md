...
Voor het maken van een testapplicatie heb ik deze [tutorial](https://www.youtube.com/watch?v=MtiUx_szKbI) gevolgd. Met behulp van deze tutorial heb ik een applicatie kunnen bouwen die een video afspeeld op het moment dat de juiste afbeelding herkent wordt.
